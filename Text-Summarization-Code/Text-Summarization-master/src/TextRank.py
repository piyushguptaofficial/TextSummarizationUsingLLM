...
def extract_word_vectors() -> dict:
    ...
    f = open('D:/JAVA Projects/Text Summarization/glove.6B.100d.txt', encoding='utf-8')
    for line in f:
        values = line.split()
        word = values[0]
